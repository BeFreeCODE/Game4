...
public class Share
{
        private const string androidMarketLink = "https://play.google.com/store/apps/details?id=com.sixtycelsius.BongBong";
        private const string appstoreLink = "https://itunes.apple.com/app/id1245041854";
        public void shareText(string title, string text)
        {
        #if UNITY_EDITOR
        #elif UNITY_IOS
                GeneralSharingiOSBridge.ShareSimpleText (title,text + "\n" + appstoreLink);
        #elif UNITY_ANDROID
